...
struct GeometryGenerationTaskData
{
    ...
    GeometryGenerationData* geometryGenerationData;
...
public:
    ...
    int AddGeometryGenerationTask(IGeometryGenerator* geometryGenerator, GeometryGenerationData* geometryGenerationData, Geometry* geometryToPopulate);
