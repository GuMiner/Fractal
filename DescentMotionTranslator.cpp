...
DescentMotionTranslator::DescentMotionTranslator()
    : wasMouseDown(false)
{
}

bool DescentMotionTranslator::CheckMouseRotation(Camera* camera)
{
...
bool DescentMotionTranslator::Update(Camera* camera, float frameTime)
{
